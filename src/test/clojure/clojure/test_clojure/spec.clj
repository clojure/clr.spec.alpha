...
(deftest conform-explain
   (let [a (s/and #(> % 5) #(< % 10))
    ...
    (are [spec x conformed ed]
      ...
      drange 3.1 3.1 nil
      drange 3.2 3.2 nil
      drange Double/PositiveInfinity ::s/invalid [{:pred '(clojure.core/fn [%] (clojure.core/not (Double/IsInfinity %))), :val Double/PositiveInfinity}]                ;;; Double/POSITIVE_INFINITY Double/isInfinite Double/POSITIVE_INFINITY	  
